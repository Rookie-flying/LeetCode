...
// -10⁴ <= Node.val <= 10⁴ 
// 
// Related Topics 树 深度优先搜索 广度优先搜索 二叉树 👍 875 👎 0
...
//            return root1;
        ...
        public void mergeTrees1(TreeNode node1, TreeNode node2) {
            ...
            if (node1 == null || node2 == null) {
                ...
                mergeTrees1(node1.left, node2.left);
                mergeTrees1(node1.right, node2.right);
            }
        }

        public TreeNode mergeTrees2(TreeNode node1, TreeNode node2) {
