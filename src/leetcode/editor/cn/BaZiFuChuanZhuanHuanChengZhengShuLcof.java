...
public class BaZiFuChuanZhuanHuanChengZhengShuLcof {
    public static void main(String[] args) {
        ...
        System.out.println(solution.strToInt("13-"));
    }
    ...
    class Solution {
        public int strToInt(String str) {
            ...
            while (i < s.length()) {
                ...
                if (temp_flag && s.charAt(i) == '+' || s.charAt(i) == '-' && temp_flag) {
                    c = s.charAt(i);
                    ++count;
                    i++;
                    continue;
                ...
                if (count > 1 || s.charAt(i) > '9' || s.charAt(i) < '0') {
                    break;
                }
                temp_flag = false;
                sum = sum*10 + (s.charAt(i) - '0');
                if (c == '+' && sum > Integer.MAX_VALUE) {
                    return Integer.MAX_VALUE;
                }
                if (c == '-' && -sum < Integer.MIN_VALUE) {
